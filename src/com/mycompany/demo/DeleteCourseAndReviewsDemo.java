    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            session.beginTransaction();
                        ...
                        //            System.out.println("got: "+review.toString() +" and trying to delete it !");
                        //            session.delete(review);
            int courseID =10;
            Course course = session.get(Course.class, courseID);
            System.out.println("got: "+course.toString() +" and trying to delete it + all the reviews using cascade.ALL !");
